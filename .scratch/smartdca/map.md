...
|---|---|---|
| [Thesis manuscript assembly](efforts/thesis-manuscript-assembly/spec.md) | active | Tickets 03--13 complete the reviewed literature, analytical and empirical chapters, discussion, introduction, conclusion, and bilingual abstracts; ticket 14 is the complete-release assembly frontier. |
...
canonical manuscript build are frozen. Ticket 02 is resolved: the thesis architecture, evidence controls, and canonical structural shell are in place. Ticket 03 is resolved: the recurring-DCA, adaptive-accumulation, online-decision, and safety-objective literature boundary is reviewed and traceable. Ticket 04 is resolved: the corrected-mean prior-theory boundary is reviewed, traceable, and conservative about novelty. Ticket 05 is resolved: outcome-blind registration, dependence-aware inference, multiplicity, reproducibility, and provenance now have reviewed source and claim boundaries. Ticket 06 is resolved: the fair same-deposit financial model, source-functional audit, corrected construction, exact homogeneity boundary, and normalized lagged signal are drafted and independently reviewed. Ticket 07 is resolved: the causal DCA impossibility, sharp epsilon-DCA unit guardrail, guarded policy algorithm, lambda-one collapse, and frictionless-versus-cost evidence boundary are drafted and independently reviewed. Ticket 08 is resolved: exact two- and three-purchase boundaries, arbitrary-horizon cash timing, qualified guardrail feedback, and the realized terminal-inventory classification are drafted and independently reviewed. Ticket 09 is resolved: Chapter 6 and Appendices C--D now define the frozen empirical design, inference limits, provenance model, artifact lifecycle, and reproduction routes on independently reviewed evidence. Ticket 10 is resolved: Chapter 7 and Appendix E now project the reviewed deterministic and seeded-stochastic evidence through four reproducible assets, with comparison-specific dispersion, downside, mechanisms, safety regressions, and fee scope kept inside their declared evidential roles. Ticket 11 is resolved: Chapter 8 and Appendix E now project the reviewed primary historical and separately registered robustness evidence through four generated assets, with independent review and inferential boundaries recorded. Ticket 12 is resolved: Chapter 9 connects the proved floor, path-dependent performance, negative historical finding, contribution/non-claim controls, limitations, and future questions on [reviewed evidence](../../research/notes/safety-adaptivity-discussion-manuscript-audit.md). Ticket 13 is resolved: the introduction, closing literature synthesis, conclusion, and bilingual abstracts align the approved questions, contribution boundaries, and historical headlines on [reviewed evidence](../../research/notes/integrative-chapters-abstract-manuscript-audit.md). Ticket 14 has a complete integrated draft and reproducible package command, but remains open pending the frozen institutional inputs and front-matter completion.
