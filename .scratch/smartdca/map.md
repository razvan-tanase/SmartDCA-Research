...
- The reviewed repository-root LLM-Wiki implementation proceeds sequentially through [Implement the SmartDCA OKF profile and report-only validator](issues/13-implement-smartdca-okf-profile-validator.md), [Atomically migrate the repository to SmartDCA OKF 0.1](issues/14-atomically-migrate-repository-to-okf.md), [Ingest the LLM-Wiki and OKF foundation sources](issues/15-ingest-llm-wiki-okf-foundation-sources.md), [Extract initial semantic concepts and certify structural freeze](issues/16-extract-semantic-concepts-certify-freeze.md), and [Clean redundancy after structural freeze](issues/17-clean-redundancy-after-structural-freeze.md).
