...
[work-tracking workflow](../../../../docs/agents/work-tracking.md) when
revisiting a ticket in this route.
...
and cash crossing alone remain insufficient. The result now feeds the active
empirical effort; no ticket in this completed effort remains active. The proof,
exact replay, publication finding, and future-work exclusions remain in the
linked theorem, review record, and ticket.
