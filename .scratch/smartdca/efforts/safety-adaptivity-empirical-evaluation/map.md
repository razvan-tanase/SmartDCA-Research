...
[Ticket 04](issues/04-establish-historical-data-episode-seam.md) is the first
open ticket whose dependencies are resolved, and no ticket is claimed. Its
historical-data boundary gates ticket 05; tickets 06 and 07 remain behind their
listed dependencies. The resolved ticket answers and linked reports are the
authority for completed-run details. The seeded stochastic report remains
