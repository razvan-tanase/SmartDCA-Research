...
Does the complete empirical package reproduce from declared inputs, satisfy the
approved protocol and repository standards, support every reported conclusion,
and remain conservative enough for the paper and master's-defense narrative?

## What to build

A reviewer independent of the producing work can reproduce representative
...
- [ ] An independent clean-environment run reproduces at least one complete deterministic or stochastic study result and one historical slice from raw inputs or immutable retrieval receipts.
- [ ] Data fingerprints, provider and series semantics, licenses, code versions, dependencies, configurations, seeds, run identities, exclusions, and artifact joins are audited and accurately reported.
- [ ] DCA independence, shared guardrail behavior, causality, full funding, frictionless unit coverage, direct wealth accounting, cost accounting, and terminal cash/unit attribution are rechecked without relying only on producer assertions.
- [ ] Episode aggregates, dependence-aware uncertainty, multiplicity boundaries, tables, figures, and prose conclusions are independently reconciled with raw outputs.
