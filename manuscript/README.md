...
the reviewed deterministic and seeded-stochastic evaluation; and Appendices
A--E retain detailed proofs, cases, protocols, artifact identities, generated
result tables, and clean commands. The historical and integrative chapters
remain structural placeholders. It is not a submission candidate.
...
- [`generated/`](generated/) contains the policy diagram and reproducible
  deterministic/stochastic tables and figures. The quantitative assets are
  regenerated by [`reproducibility/synthetic_evaluation_assets.py`](../reproducibility/synthetic_evaluation_assets.py)
  from accepted immutable run bundles.
...
runs the finite/arbitrary-horizon boundary, empirical-methodology, and
deterministic/stochastic evaluation audits before LaTeX so scope, notation,
evidence mappings, Appendices B--E, generated result assets, frozen protocol
identities, and private/public boundaries cannot drift independently.
